...
public:
    ...
    Color3B returnPenColor(int _colorIndex);
...
//    int SelectColorTag = 100 ;
    ...
    float colorCrayonFinePos[30];
    float colorMarkerPos[30];
    ...
    bool firstTouchCrayonFine;
    bool firstTouchMarker;
