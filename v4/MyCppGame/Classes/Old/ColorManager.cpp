...
void ColorManager::initColorManager(){
    ...
    reverseB = false;
    colorBookIndex=0;
    curPaintPenColorIndex=0;
    curPencilPenColorIndex=0;
    touchedPenButton=false;
    isNewbieGuideActive=false;
    
//    curColorTheme = 10;   //圣诞节
    curColorTheme = 12;
    curThemeTotalCount=18;
    selectedColorTheme = false;
    isMovingColorBlock = false;
...
//    int themeIdArr[12] = {2,5,1,8,3,9,7,6,4,0,10,11};   //万圣节
//    int themeIdArr[15] = {2,5,1,12,13,14,3,8,9,7,6,4,0,10,11};
//    int themeIdArr[12] = {2,5,1,10,3,8,9,7,6,4,0,11};   //圣诞节
    int themeIdArr[18] = {6,12,7,1,9,2,16,11,15,14,5,4,3,17,0,13,8,10};
    for (int i = 0; i < 18; i++) {
        themeIndexArr[i] = themeIdArr[i];
    }
    ...
    if (!CCUserDefault::sharedUserDefault()->getBoolForKey("cleanAllLastFiles", false)) {
        this->removeAllNeedToRemoveFiles();
    }
    if (!CCUserDefault::sharedUserDefault()->getBoolForKey("cleanAllLastFiles2025", false)) {
        this->removeTwentyFiveNeedToRemoveFiles();
    }
//    yDis=-2360;
}
...
void ColorManager::initColorValue(){
    curPaintIndex = 11;
    curPencilIndex = 6;
    curPaintbucketIndex = 23;
    curCrayonIndex = 18;
    curLargebrushIndex = 31;
    curSelectColorIndex=1;
...
void ColorManager::changeCurColor()
{
    ...
    switch (tag) {
        case 1:
            colorVal = ccc3(217,190,160);
            break;
        case 2:
            colorVal = ccc3(245,165,104);
           break;
        case 3:
            colorVal = ccc3(234,129,136);
            break;
        case 4:
            colorVal = ccc3(239,99,138);
            break;
        case 5:
            colorVal = ccc3(207,5,17);
            break;
        case 6:
            colorVal = ccc3(233,49,13);
            break;
        case 7:
            colorVal = ccc3(235,84,31);
            break;
        case 8:
            colorVal = ccc3(243,152,1);
            break;
        case 9:
            colorVal = ccc3(208,159,5);
            break;
        case 10:
            colorVal = ccc3(247,180,1);
            break;
        case 11:
            colorVal = ccc3(255,235,0);
            break;
        case 12:
            colorVal = ccc3(252,255,60);
            break;
        case 13:
            colorVal = ccc3(172,204,5);
            break;
        case 14:
            colorVal = ccc3(150,173,31);
            break;
        case 15:
            colorVal = ccc3(63,178,51);
            break;
        case 16:
            colorVal = ccc3(3,199,56);
            break;
        case 17:
            colorVal = ccc3(1,154,72);
            break;
        case 18:
            colorVal = ccc3(1,158,113);
            break;
        case 19:
            colorVal = ccc3(115,195,158);
            break;
        case 20:
            colorVal = ccc3(133,204,200);
            break;
        case 21:
            colorVal = ccc3(88,188,238);
            break;
        case 22:
            colorVal = ccc3(39,128,196);
            break;
        case 23:
            colorVal = ccc3(2,105,184);
            break;
        case 24:
            colorVal = ccc3(0,106,148);
            break;
        case 25:
            colorVal = ccc3(1,65,153);
            break;
        case 26:
            colorVal = ccc3(10,51,103);
            break;
        case 27:
            colorVal = ccc3(82,48,142);
            break;
        case 28:
            colorVal = ccc3(92,40,89);
            break;
        case 29:
            colorVal = ccc3(121,24,101);
            break;
        case 30:
            colorVal = ccc3(167,45,144);
            break;
        case 31:
            colorVal = ccc3(235,157,196);
            break;
        case 32:
            colorVal = ccc3(215,24,120);
            break;
        case 33:
            colorVal = ccc3(171,8,85);
            break;
        case 34:
            colorVal = ccc3(174,92,52);
            break;
        case 35:
            colorVal = ccc3(180,121,55);
            break;
        case 36:
            colorVal = ccc3(98,77,58);
            break;
        case 37:
            colorVal = ccc3(77,71,47);
            break;
        case 38:
            colorVal = ccc3(3,3,3);
            break;
        case 39:
            colorVal = ccc3(137,137,137);
            break;
        case 40:
            colorVal = ccc3(212,212,214);
            break;
        case 41:
...
bool ColorManager::checkIsNeedToRemoveFile(std::string _fileName){
...
void ColorManager::removeAllNeedToRemoveFiles(){
    CCDictionary* allremoveInfo = CCDictionary::createWithContentsOfFile("DinoColor/allneedtoremove_info.plist") ;
    if (allremoveInfo != NULL) {
        CCArray* keysNameArr = allremoveInfo->allKeys();
        
        int removeCount = 0;
        for (int i = 0; i < keysNameArr->count(); i++) {
            std::string canvasFileName = ((CCString*)keysNameArr->objectAtIndex(i))->m_sString+"canvas";
            this->removeImageBinaryFile(canvasFileName);
            
            const char* keysName = ((CCString*)keysNameArr->objectAtIndex(i))->getCString();
            CCDictionary* childRemoveArrDic = (CCDictionary*)allremoveInfo->objectForKey(keysName);
            int removeChildCount = 0;
            if (childRemoveArrDic != NULL) {
                removeChildCount = childRemoveArrDic->count();
                if (removeChildCount > 0) {
                    CCArray* childNameArr = childRemoveArrDic->allKeys();
                    for (int j = 0; j < childNameArr->count(); j++) {
                        std::string childFileName = ((CCString*)keysNameArr->objectAtIndex(i))->m_sString+((CCString*)childNameArr->objectAtIndex(j))->m_sString;
                        this->removeImageBinaryFile(childFileName);
                        removeChildCount--;
                    }
                }
            }
        ...
        if (removeCount >= keysNameArr->count()) {
            CCUserDefault::sharedUserDefault()->setBoolForKey("cleanAllLastFiles", true);
        }
    }
}

void ColorManager::removeTwentyFiveNeedToRemoveFiles(){
    CCDictionary* allremoveInfo = CCDictionary::createWithContentsOfFile("DinoColor/allneedtoremove_info_2025.plist") ;
    if (allremoveInfo != NULL) {
        CCArray* keysNameArr = allremoveInfo->allKeys();
        ...
        if (removeCount >= keysNameArr->count()) {
            CCUserDefault::sharedUserDefault()->setBoolForKey("cleanAllLastFiles2025", true);
        }
    }
}

bool ColorManager::removeImageBinaryFile(std::string _fileName){
